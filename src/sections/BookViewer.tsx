...
export default function BookViewer() {
  ...
  const loadBookPages = useCallback((book: typeof LIBRARY[0]) => {
    const pages = [`/images/books/${book.cover}`];
    const samples = SAMPLE_PAGES[book.id] || [];
    samples.forEach(filename => {
      pages.push(`/sample/${book.sampleFolder}/${filename}`);
    });
    return pages;
  }, []);
    ...
    <div className="book-viewer">
      <div className="status-bar">
        <div className="status-indicator">
          ...
          <span>Visualizador v2.0 • {LIBRARY.length} títulos</span>
        </div>
            ...
            return (
              <div key={book.id} className="book-card" onClick={() => openBook(book.id)}>
                <div className="book-cover-wrap">
                  ...
                  <img
                    src={getUrl(`/images/books/${book.cover}`)}
          ...
          <div className="viewer-container">
            <div className="viewer-toolbar">
              <div className="viewer-title">
                <img src={getUrl(bookPages[0])} className="viewer-thumb" alt="" />
            ...
            <div className="viewer-stage">
              ...
              <div className="book-display">
                <div className="book-page-container" style={{ transform: `scale(${zoom})` }}>
                  <img src={getUrl(bookPages[currentPageIndex])} alt="" />
      ...
      <style>{`
        ...
        .cover-placeholder { position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; font-size: 3rem; }
        .book-cover { width: 100%; height: 100%; object-fit: cover; opacity: 0; transition: opacity 0.3s; }
        ...
        @media (max-width: 768px) {
          ...
          .viewer-toolbar { padding: 10px 15px; }
          .viewer-info h3 { font-size: 0.9rem; }
          .nav-overlay { width: 50px; }
          .nav-overlay span { font-size: 2rem; }
        }
      `}</style>
    </div>
  );
